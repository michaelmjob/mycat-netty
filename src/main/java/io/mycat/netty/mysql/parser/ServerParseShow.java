package io.mycat.netty.mysql.parser;

import io.mycat.netty.util.ParseUtil;
...
public final class ServerParseShow {
    ...
    // should refactor, add unfinished show command
    ...
    public static final int TABLES = 12;
    // show engines
    // @author little-pan
    // @since 2016-07-13
    ...
    // should refactor , pattern can be precompiled firstly
