...
//            }
    ...
    private void tryRoute(SchemaConfig schema, RouteResultset rrs) throws SQLNonTransientException {
...
//        for (RouteCalculateUnit unit : ctx.getRouteCalculateUnits()) {
//
//            RouteResultset rrsTmp = RouterUtil.tryRouteForTables(schema, ctx, unit, rrs, true);
