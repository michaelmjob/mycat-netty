...
public class DefaultDruidParser implements DruidParser {
    private static final Logger logger = LoggerFactory.getLogger(DefaultDruidParser.class);
    /**
     * 解析得到的结果
     */
     ...
     * @param stmt
     */
    public void parser(SchemaConfig schema, RouteResultset rrs, SQLStatement stmt, String originSql, MycatSchemaStatVisitor schemaStatVisitor) throws SQLNonTransientException {
